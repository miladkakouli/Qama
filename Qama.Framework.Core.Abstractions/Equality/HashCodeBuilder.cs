...
namespace Qama.Framework.Core.Abstractions.Equality
{
    public class HashCodeBuilder
    {
            ...
            Type reflectUpToClass)
        {
            if (obj == null)
            {
                throw new InternalApplicationException(InternalApplicationExceptionDomain.DefaultApplicationException, "The object to build a hash code for must not be null");
            }
            ...
            for (int i = 0; i < fields.Length; i++)
            {
                    ...
                    && !f.IsStatic)
                {
                    ...
                    catch (Exception)
                    {
                        ...
                        throw new InternalApplicationException(InternalApplicationExceptionDomain.DefaultApplicationException, "Unexpected IllegalAccessException");
                    }
                }
            }
        }
